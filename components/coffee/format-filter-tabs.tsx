...
export default function FormatFilterTabs({
  products,
  selectedFormat,
  onFormatChange,
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-[#6E6658]">
                {selectedFormat === 'whole-bean' &&
                  'Grind fresh at home for maximum flavor and aroma'}
                {selectedFormat === 'ground' &&
                  'Ready to brew - perfect for drip coffee makers and pour-over'}
