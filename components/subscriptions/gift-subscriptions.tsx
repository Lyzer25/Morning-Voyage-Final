      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="inline-flex items-center space-x-2 bg-white/60 backdrop-blur-sm rounded-full px-6 py-3 border border-white/20 shadow-lg mb-6">
            ...
            <span className="text-[#4B2E2E] text-sm font-semibold tracking-wide">GIFT SUBSCRIPTIONS</span>
          </div>
          ...
          <p className="text-xl text-[#6E6658] max-w-3xl mx-auto font-light leading-relaxed">
            Give the gift of exceptional coffee. Our gift subscriptions are perfect for birthdays, holidays, or any
            special occasion.
          </p>
        </div>
              ...
              <CardContent className="text-center">
                  ...
                  {product.defaultVariant.originalPrice && (
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <span className="text-sm text-[#9E7C83] font-semibold">
                        Save {calculateSavings(product.defaultVariant.originalPrice, product.defaultVariant.price)}
                      </span>
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-3 mb-8">
                  <div className="flex items-center text-[#6E6658]">
                    ...
                    <span>{product.longDescription || "Premium coffee"}</span>
                  </div>
                  <div className="flex items-center text-[#6E6658]">
                ...
                <p className="text-xs text-[#6E6658] mt-3 font-light">Delivered via email instantly</p>
              </CardContent>
            </Card>
          ))}
        </div>
