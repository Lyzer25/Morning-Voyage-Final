      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="inline-flex items-center space-x-2 bg-white/60 backdrop-blur-sm rounded-full px-6 py-3 border border-white/20 shadow-lg mb-6">
            ...
            <span className="text-[#4B2E2E] text-sm font-semibold tracking-wide">YOU MIGHT ALSO LIKE</span>
          </div>
          <h2 className="text-4xl sm:text-5xl font-black text-[#4B2E2E] mb-6 tracking-tight">Related Products</h2>
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                      <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                        <Button size="sm" className="bg-white text-[#4B2E2E] hover:bg-white/90 rounded-full shadow-xl">
